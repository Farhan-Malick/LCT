            ...
            <div class="row px-0 mx-0">
                <div class="col-lg-3">
                    <div class="card p-3 shadow-sm br-10 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="tickets-details d-sm-flex d-block justify-content-between">
                                <p>Sale Tax  </p>
                                {{$tickets->currency}}<span id="taxpriceticket"> .00 </span>
                            </div>
                            <div class="tickets-details d-sm-flex d-block justify-content-between">
                                <p>Ticket Price</p>
                                {{$tickets->currency}} <p id="priceticket" > {{$tickets->price}} </p>Per ticket
                ...
                <div class="col-lg-9">
                    <div class="card p-3 shadow-sm br-10 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="" class="btn btn-primary">Finish & Check your Ticket</a>
                            </div>
                        </div>
                        {{-- <div class="row">
                            <div class="col-md-12">
                ...
                {{-- <div class="col-lg-3">
                    <div class="card  shadow-sm br-10 mb-3">
                        <div class="card-body">
                            ...
                            <img src="../../assets/images/hoston.jpg" class="img-fluid br-10" alt="">
                        </div>
                    </div>
                </div> --}}
            </div>
...
{{-- <script>
        ...
        $('select').on('change', function() {
            $('#noticket').empty();
            $('#noticket').append(this.value);
            $('#taxpriceticket').empty();
            $('#taxpriceticket').append(this.value*{{$tickets->price}}*0.15);
            $('#priceticket').empty();
            $('#priceticket').append(this.value*{{$tickets->price}}+this.value*{{$tickets->price}}*0.15)
            $('#pricetotal').empty();
            $('#pricetotal').val(this.value*{{$tickets->price}}+this.value*{{$tickets->price}}*0.15);
        });
