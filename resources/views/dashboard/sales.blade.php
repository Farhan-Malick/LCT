                        ...
                        <div class="col-md-12">
                            <nav class="orders-tabs">
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <button class="nav-link active fw-600 " id="nav-open-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-open" type="button" role="tab" aria-controls="nav-open"
                            ...
                            <div class="tab-content mt-3" id="nav-tabContent">
                                                ...
                                                <form action="">
                                                    <div class="input-group mb-3">
                                                        <input type="search" class="form-control"
                                                            placeholder="Search for slaes by event name or listing ID"
                                ...
                                <div class="tab-pane fade" id="nav-completed" role="tabpanel"
                                    ...
                                    <div class="card shadow-sm mb-3">
                                        <div class="card-body">
                                            <h5 class="card-title fw-600 text-center">You don't have any Sales</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
