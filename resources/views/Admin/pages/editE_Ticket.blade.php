...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Edit E-Ticket</h1>
<!-- end page-header -->
<div class="row">
    <!-- begin col-6 -->
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-body">
                <form
                    ...
                    action="{{ URL('/Admin-Panel/E-Ticket/update/'.$e_ticket->id) }} "enctype="multipart/form-data"
                    method="POST"
                >
                    @csrf
