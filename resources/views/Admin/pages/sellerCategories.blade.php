...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Seller Categories</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Seller Categories</h1>
<!-- end page-header -->
<div class="row">
    <!-- begin col-6 -->
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-body">
                <form
                    ...
                    action="{{ route('admin.sellerCategory.create') }}"
                    method="POST"
                >
                    @csrf
                    <div class="form-group row m-b-15">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <input
                                ...
                                type="text"
                                name="categories"
                                placeholder="Enter Seller Categories"
                            />
                        </div>
                    </div>
                ...
                <table class="table mt-3">
                    <thead class="thead-dark">
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Seller Category</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$sellerCategory->id}}</td>
                            <td>{{$sellerCategory->categories}}</td>
                            <td>
                                <a
                                    class="btn btn-primary"
                                    href="{{route('admin.sellerCategory.edit',$sellerCategory->id)}}"
                                    >Edit</a
                                >

                                <a
                                    class="btn btn-danger"
                                    href="{{route('admin.sellerCategory.destroy',$sellerCategory->id)}}"
                                    >Delete</a
                                >
                            </td>
                        </tr>
