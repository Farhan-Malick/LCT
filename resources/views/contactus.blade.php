    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2>Contact Us</h2>
          <p>Here is the last chance to be the member of world’s leading ticket marketplace for live events around the
            globe.</p>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <fieldset>
                    ...
                    <select name="country" value="{{ old('country') }}" autocomplete="country" autofocus
                ...
                <div class="col-lg-12 mb-5">
                  <fieldset>
                    ...
                    <div class="form-outline">
                      <textarea class="form-control form-control-lg" name="message" id="textAreaExample1"
                        rows="4"></textarea>
                    </div>
                  </fieldset>
                </div>
