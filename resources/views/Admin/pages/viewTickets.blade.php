...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
        ...
        <ol class="breadcrumb float-xl-right">
            ...
            <li class="breadcrumb-item active">E-Tickets Detail</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
    ...
    >
                    ...
                    <div class="panel-body">
                        <div class="row">
                            @foreach ($e_tickets as $e_ticket)
                                <div class="col-md-4 ">
                                    <img src="{{ asset('etickets/' . $e_ticket->ticket_path) }}"height="500px" width="100%" alt="">
                                </div>
                            @endforeach
                        </div>
                    </div>
		...
		<!-- end #content -->
	   {{-- @foreach ($e_tickets as $e_ticket)
                <img src="{{ asset('public/etickets/' . $e_ticket->ticket_path) }}" alt="">
           @endforeach --}}
