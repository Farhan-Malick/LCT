                    ...
                    <form action="{{ route("register") }}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                <div class="form-outline">
                                    <input type="email" class="form-control form-control-lg" id="emailrepeat" name="email_confirmation">
                            ...
                            <div class="form-outline mb-4">
                                <input type="password" class="form-control form-control-lg" id="confirmpass" name="password_confirmation">
