              ...
              <div class="col-lg-12">
                {{-- @if ($tickets->ticket_type === "E-Ticket" )
                  ...
                  @endif
                    ...
                    <form action="{{route('seller.complete_ticket.address.store',$tickets->id)}}" enctype="multipart/form-data" method="post" id="reservation-form">
                      @csrf
                      <div class="col-lg-12">
                        
                          <h4>Please Submit <em>E-Ticket</em> Form<em></em></h4>
                      </div>
                        <fieldset>
                ...
                @elseif($tickets->ticket_type === "Mobile-Ticket" )
                <div class="col-lg-12">
                  @if ($message = Session::get('msg'))
                  <div class="alert alert-success alert-block">
                      <strong>{{ $message }}</strong>
                  ...
                  <form action="{{route('seller.complete_ticket.address.store',$tickets->id)}}" enctype="multipart/form-data" method="post" id="reservation-form">
                    @csrf
                    <div class="col-lg-12">
                        <h4>Please Submit <em>Mobile-Ticket</em> Form<em></em></h4>                  
                    </div>
                    <div class="col-lg-12">
