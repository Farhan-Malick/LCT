				...
				<div class="panel panel-inverse">
					...
					<div class="panel-body">
                        ...
                        {{-- <h5 class="text-center">
                            Total Tickets : {{$ticketVisitors->count()}} 
                        </h5> --}}
							...
							<tbody>
									@foreach($ticketVisitors as $visits)
                                       @if ($visits->completed === 1)
                                            @if($visits->quantity != 0)
                                                <tr>
                                                    <td>{{$visits->id}}</td>
                                                    <td><b class="text-success">{{$visits->views}}</b></td>
                                                    <td>{{$visits->event_name}}</td>
                                                    <td>${{$visits->price}}</td>
                                                    <td>{{$visits->quantity}}</td>
                                                    <td>{{$visits->type_cat}}</td>
                                                    <td>{{$visits->type_sec}}</td>
                                                    <td>{{$visits->type_row}}</td>
                                                    <td>{{$visits->ticket_type}}</td>
                                                </tr>
                                            @endif
                                       @endif
									@endforeach
