{{-- <section class="section-five">
    <div class="footer ">
        <div class="container p-5">
            <div class="row">
                <div class="col-xl-3">
                    <h5 class="mb-4 text-dark">Regional Settings</h5>
                ...
                <div class="col-xl-3">
                    <h5 class="mb-4 text-dark">More</h5>
                    <ul>
                        ...
                        <li><a href="" class="text-dark">How do i contact?</a></li>
                        <li><a href="" class="text-dark">Event Organizers</a></li>
                    </ul>
                </div>
                <div class="col-xl-3">
                    <h5 class="mb-4 text-dark">Popular Events</h5>
                </div>
                <div class="col-xl-3">
                    <h5 class="mb-4 text-dark">Stay Up to Date</h5>
...
<div class="footer  mt-5">
    <div class="container foot__con">
        <div class="row  pt-5 ">
            ...
            <div class="col-md-3">
                <ul>
                    <h4 class="text-dark">POPULAR ITEMS</h4>
                    <li class=" mt-5"><a href="" class="text-dark">Arsenal Tickets</a>
                    </li>
                    <li class=" mt-2"><a href="" class="text-dark">Manchester City Tickets</a></li>
                    <li class=" mt-2"><a href=""
                            class="text-dark">Liverpool Tickets</a>
                    </li>
                    <li class=" mt-2"><a href=""
                            class="text-dark">Barcelona Tickets</a></li>
                    <li class=" mt-2"><a href="" class="text-dark">Real Madrid Tickets</a></li>
                </ul>
            </div>
            <div class="col-md-3 foot__iconss ">
                <ul>
                    <h4 class="text-dark ">HOT TICKETS</h4>
                    <li class=" mt-5"><a href="" class="text-dark">Arsenal Vs Brentford FC</a>
                    </li>
                    <li class=" mt-2"><a href="" class="text-dark">Real Madrid Vs Elche CF</a></li>
                    <li class=" mt-2"><a href=""
                            class="text-dark">Arsenal Vs Manchester City</a>
                    </li>
                    <li class=" mt-2"><a href=""
                            class="text-dark">Manchester United Vs Barcelona</a></li>
                    <li class=" mt-2"><a href="" class="text-dark">Manchester United Vs Newcastle United</a></li>
                </ul>
            </div>
        </div>
