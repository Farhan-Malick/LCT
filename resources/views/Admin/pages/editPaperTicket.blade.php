...
<ol class="breadcrumb float-xl-right">
    ...
    <li class="breadcrumb-item active">Edit Paper Ticket</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Edit Paper Ticket</h1>
<!-- end page-header -->
<div class="row">
    <!-- begin col-6 -->
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-body">
                <form
                    ...
                    action="{{ URL('/Admin-Panel/PaperTicket/update/'.$paper_ticket->id) }} "enctype="multipart/form-data"
                    method="POST"
                >
                    @csrf
